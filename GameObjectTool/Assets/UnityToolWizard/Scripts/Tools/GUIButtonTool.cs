...
{
    public static void CreateButton<TArg>(string _label, Color _colorText, Color _colorBackground, Action<TArg> _callback, TArg _arg0, int _fontSize = 12, TextAnchor _align = TextAnchor.MiddleCenter, FontStyle _fontStyle = FontStyle.Bold)
    {
